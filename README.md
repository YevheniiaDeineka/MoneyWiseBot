...
* 🎯 **Цілі заощаджень:** Розрахунок необхідних щомісячних внесків або часу для досягнення фінансової мети (з урахуванням % ставки).
...
1. **Клонуйте репозиторій:**
   ```bash
   git clone [https://github.com/ВАШ_ЮЗЕРНЕЙМ/MoneyWiseBot.git](https://github.com/ВАШ_ЮЗЕРНЕЙМ/MoneyWiseBot.git)
   cd MoneyWiseBot
   ```
...
* `/memory` — *Секретна команда розробника.* Виводить поточний стан гібридної пам'яті (Buffer + Summary) для діагностики агента.
